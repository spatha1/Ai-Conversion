...
const SECTION_META: Record<string, { label: string; color: string }> = {
  ...
  conversion:          { label: 'P&C',              color: tokens.violet600 },
  la:                  { label: 'L&A',              color: tokens.emerald600 },
  development:         { label: 'SQL Agent',        color: tokens.emerald600 },
  'dev-hub':           { label: 'Design Hub',       color: tokens.indigo600 },
  dashboards:          { label: 'Dashboards',       color: tokens.sky600 },
  'my-dashboards':     { label: 'Dashboards',       color: tokens.sky600 },
  ...
  sai:                 { label: 'SAI',              color: tokens.violet600 },
  knowledge:           { label: 'SAI Knowledge',   color: tokens.violet600 },
  testing:             { label: 'Testing / Recon',  color: tokens.amber600 },
  reports:             { label: 'Reports',          color: tokens.amber600 },
  'form-builder':      { label: 'Form Builder',     color: tokens.sky600 },
  'query-intelligence':{ label: 'Query Intelligence', color: tokens.indigo600 },
  'payload-intelligence':{ label: 'Payload Intelligence', color: tokens.indigo600 },
