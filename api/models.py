...
class KnowledgeEntry(Base):
    ...
    id                   = Column(Integer, primary_key=True, autoincrement=True)
    title                = Column(String(500), nullable=False)
    type                 = Column(String(50),  nullable=False)   # UseCase|Question|Process|Issue|ViewDefinition|QueryExample|QueryLibrary|SchemaDefinition|OperationalRule|XMLPathDefinition|XMLMapping|DependencyDefinition|FieldMapping|DiagramDefinition|QueryDefinition|ProcessLineage|SQLObject|ColumnMetadata|BusinessRule|DataLineage
