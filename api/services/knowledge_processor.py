...
def ask_sai(
    *,
    ...
    # ── Listing intent detection (LLM classifier) ────────────────────────────────
    # Semantic search returns top-k chunks — useless for "list ALL objects" queries.
    # Ask gpt-4o-mini YES/NO whether the question wants to enumerate all SQL objects.
    # No regex — any phrasing works naturally.
    _is_listing_query = False
    try:
